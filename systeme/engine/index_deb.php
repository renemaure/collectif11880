<?php
	/*
		...
		Actuellement à la version 5.5.6 au 12/05/2024.

		la version 5.5.6 comprend:
			Ajout d'une super variable pour l'indexation des liens des modules
			 en phase test pour tabbord
			...
			La variable $pg_court renseigne le nom de la page courante pour faire fonctionner les modules.
	...
	*/
	...
	/* condition index un fichier json du nom de la page courante pour l'automatisation des données de la BDD, en version test pour tabord_2024  non utiliser voir si utiliser*/
